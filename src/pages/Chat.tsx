...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      <header className="flex-none sticky top-0 z-20 bg-card/95 backdrop-blur-md border-b border-border shadow-sm px-2 sm:px-4 py-2.5 flex items-center gap-1.5 sm:gap-2">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => {
        ...
        {chatMode === "voice" ? (
          ...
          <div className="flex-1 flex flex-col overflow-hidden bg-background">
            ...
            <ScrollArea className="flex-1 overflow-y-auto" style={{ scrollBehavior: "smooth" }}>
              <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4 sm:space-y-5">
                {isWelcomeState ? (
                  <div className="flex flex-col items-center justify-center text-center py-10 sm:py-16 gap-4 animate-in fade-in duration-500">
                    <div className="relative">
                      <img
                        src={logo}
                        alt="Studymate AI"
                        className="h-20 w-20 sm:h-24 sm:w-24 rounded-2xl object-contain bg-white border border-border shadow-md"
                      />
                      <span className="absolute -inset-1 rounded-2xl bg-primary/20 blur-2xl -z-10" />
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-2 pt-2 max-w-md">
                      {quickPrompts.map((qp) => (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-2 rounded-full border border-border bg-card hover:bg-muted active:scale-95 transition-all text-xs sm:text-sm text-foreground shadow-sm"
                        >
                  ...
                  messages.map((message, index) => (
                    ...
                    >
                      {message.role === "assistant" && (
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white border border-border flex items-center justify-center overflow-hidden shadow-sm">
                          <img src={logo} alt="AI" className="h-7 w-7 object-contain" />
                        </div>
                      )}
                      <div
                        className={`max-w-[85%] sm:max-w-[78%] px-3.5 sm:px-4 py-2.5 sm:py-3 shadow-sm ${
                          message.role === "user"
            ...
            <div className="flex-none bg-gradient-to-t from-background via-background to-background/80 px-2.5 sm:px-4 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
              <div className="max-w-4xl mx-auto">
                <div className="flex items-end gap-2 bg-card border border-border rounded-3xl shadow-[0_-2px_12px_-4px_rgba(0,0,0,0.06)] px-2 py-1.5">
